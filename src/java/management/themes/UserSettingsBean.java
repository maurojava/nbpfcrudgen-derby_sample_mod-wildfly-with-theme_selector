...
public class UserSettingsBean implements Serializable {
    ...
    public void setTheme(Theme theme) {
        this.theme = theme;
         System.out.println("theme selected is: "+theme.getDisplayName()+ "\n - with name: "+theme.getName());
    }
    ...
    public void init() {
     ...
     //   theme = availableThemes.get(18);
        ...
        // set "Aristo" theme as default
      theme = availableThemes.get(3);
       
        // set "AfterDark" theme as default
                System.out.println("theme selected is: "+theme.getDisplayName());
    }
